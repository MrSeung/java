...
public class ThreadEx01 {
	...
	public static void main(String[] args) {
		...
		/* Thread : 실행중인 프로그램(process)이 OS로부터 메모리를 할당 받아 process 상태가 됨 
		 ...
		 * - 여러 thread가 공유하는 지원중 경쟁이 발생하는 부분을 critical section(임계영역)
		 * - critical section에 대한 동기화(순차적 수행)를 구현하여 오류를 막음.
		 * 
		 * thread 구현 방식 상속(Thread), 구현하는 방식(Runable) 
		 * */
